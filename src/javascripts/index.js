...
// JavaScript
//TODO
import {movies} from './movies';//links the movies array from "movies.js" to "index.js"

let featured_movies = document.querySelector('.featured');//give access to the div element with the "featured"
...
function selectMovie(m){
    featured_movies.innerHTML = `<img src="${m.poster}" style="float:left;">
    <h1>${m.title}</h1>
    <p>${m.plot}</p>
    ` 
}
